    ...
    <div class="dashboard-container">
      ...
      @if (userStore.activeRole() === 'FIXER' && !verificationStore.verified()) {
        <section class="panel-section verification-callout">
          ...
          <p>Completa tu verificación para acceder a solicitudes disponibles y publicar tu portafolio profesional.</p>
          <a class="primary-action" routerLink="/fixers/verification">Completar verificación</a>
        </section>
      }
          ...
          @for (action of primaryActions(); track action.label) {
            <a class="action-card" [routerLink]="action.path">
              ...
              <span>
                ...
                @if (action.requiresVerification) { <small>Requiere verificación</small> }
              </span>
            </a>
          }
        </div>
...
export class DashboardComponent {
  ...
  private actionDescription(path: string, role = this.userStore.activeRole()): string {
    ...
    if (path === '/fixers/verification' && role === 'FIXER') return 'Completa tu verificación para acceder a solicitudes disponibles y publicar tu portafolio profesional.';
